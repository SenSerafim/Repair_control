...
export const ErrorCodes = {
  ...
  PAYMENT_SELF_PAYMENT_FORBIDDEN: 'payments.self_payment_forbidden',
  ...
  TOOL_NOT_IN_PROJECT: 'tools.not_in_project',
  ...
  LEGAL_PUBLICATION_NOT_FOUND: 'legal_publications.not_found',
  LEGAL_PUBLICATION_FILE_MISSING: 'legal_publications.file_missing',
  LEGAL_PUBLICATION_SLUG_TAKEN: 'legal_publications.slug_taken',
  KNOWLEDGE_CATEGORY_NOT_FOUND: 'knowledge.category_not_found',
  KNOWLEDGE_ARTICLE_NOT_FOUND: 'knowledge.article_not_found',
  KNOWLEDGE_ASSET_NOT_FOUND: 'knowledge.asset_not_found',
  KNOWLEDGE_ASSET_FILE_MISSING: 'knowledge.asset_file_missing',
  KNOWLEDGE_INVALID_MODULE_SLUG: 'knowledge.invalid_module_slug',
