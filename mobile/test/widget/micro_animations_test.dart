...
void main() {
  testWidgets('AppAnimatedSendButton — send → check при sent=true', (
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(body: AppAnimatedSendButton(onTap: () {})),
      ),
    );
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(body: AppAnimatedSendButton(onTap: () {}, sent: true)),
      ),
    );
  ...
  testWidgets('AppUploadProgressBar рисуется', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(body: AppUploadProgressBar(progress: 0.5)),
      ),
    );
    await tester.pump(const Duration(milliseconds: 100));
