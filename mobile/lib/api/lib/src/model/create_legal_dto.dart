...
class CreateLegalDto {
  ...
  final String bodyMd;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateLegalDto &&
      other.kind == kind &&
      other.title == title &&
      other.bodyMd == bodyMd;
  ...
  factory CreateLegalDto.fromJson(Map<String, dynamic> json) => _$CreateLegalDtoFromJson(json);
