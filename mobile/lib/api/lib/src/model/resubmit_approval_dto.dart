...
class ResubmitApprovalDto {
  ...
  ResubmitApprovalDto({this.payload, this.attachmentKeys});
  ...
  bool operator ==(Object other) =>
      ...
      other is ResubmitApprovalDto &&
          other.payload == payload &&
          other.attachmentKeys == attachmentKeys;

  @override
  int get hashCode => payload.hashCode + attachmentKeys.hashCode;

  factory ResubmitApprovalDto.fromJson(Map<String, dynamic> json) =>
      _$ResubmitApprovalDtoFromJson(json);
