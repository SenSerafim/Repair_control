...
class MaterialItemInputDto {
  ...
  @JsonKey(name: r'pricePerUnit', required: false, includeIfNull: false)
  final num? pricePerUnit;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is MaterialItemInputDto &&
          other.name == name &&
          other.qty == qty &&
          other.unit == unit &&
          other.note == note &&
  ...
  factory MaterialItemInputDto.fromJson(Map<String, dynamic> json) =>
      _$MaterialItemInputDtoFromJson(json);
