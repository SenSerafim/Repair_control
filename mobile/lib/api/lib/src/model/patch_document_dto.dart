...
class PatchDocumentDto {
  ...
  final String? stepId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PatchDocumentDto &&
      other.title == title &&
  ...
  factory PatchDocumentDto.fromJson(Map<String, dynamic> json) => _$PatchDocumentDtoFromJson(json);
