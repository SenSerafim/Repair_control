...
class PatchSettingDto {
  ...
  PatchSettingDto({required this.kind, required this.pushEnabled});
  ...
  bool operator ==(Object other) =>
      ...
      other is PatchSettingDto &&
          other.kind == kind &&
          other.pushEnabled == pushEnabled;

  @override
  int get hashCode => kind.hashCode + pushEnabled.hashCode;

  factory PatchSettingDto.fromJson(Map<String, dynamic> json) =>
      _$PatchSettingDtoFromJson(json);
