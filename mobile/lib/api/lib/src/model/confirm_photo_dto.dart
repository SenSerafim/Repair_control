...
class ConfirmPhotoDto {
  ...
  @JsonKey(name: r'fileKey', required: true, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is ConfirmPhotoDto &&
          other.fileKey == fileKey &&
          other.mimeType == mimeType &&
          other.sizeBytes == sizeBytes;

  @override
  int get hashCode => fileKey.hashCode + mimeType.hashCode + sizeBytes.hashCode;

  factory ConfirmPhotoDto.fromJson(Map<String, dynamic> json) =>
      _$ConfirmPhotoDtoFromJson(json);
