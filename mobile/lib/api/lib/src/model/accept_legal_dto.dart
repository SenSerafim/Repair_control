...
class AcceptLegalDto {
  ...
  AcceptLegalDto({required this.kind});
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is AcceptLegalDto && other.kind == kind;

  @override
  int get hashCode => kind.hashCode;

  factory AcceptLegalDto.fromJson(Map<String, dynamic> json) =>
      _$AcceptLegalDtoFromJson(json);
