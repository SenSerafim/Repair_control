...
class CreateApprovalDto {
  ...
  final List<String>? attachmentKeys;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateApprovalDto &&
      other.scope == scope &&
  ...
  factory CreateApprovalDto.fromJson(Map<String, dynamic> json) => _$CreateApprovalDtoFromJson(json);
