...
class ReorderItemDto {
  ...
  ReorderItemDto({required this.id, required this.orderIndex});
  ...
  factory ReorderItemDto.fromJson(Map<String, dynamic> json) =>
      _$ReorderItemDtoFromJson(json);
