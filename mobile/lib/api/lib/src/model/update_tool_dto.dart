...
class UpdateToolDto {
  ...
  final String? photoKey;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UpdateToolDto &&
      other.name == name &&
  ...
  factory UpdateToolDto.fromJson(Map<String, dynamic> json) => _$UpdateToolDtoFromJson(json);
