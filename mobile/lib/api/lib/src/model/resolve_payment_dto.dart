...
class ResolvePaymentDto {
  ...
  final num? adjustAmount;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ResolvePaymentDto &&
    ...
    int get hashCode =>
        resolution.hashCode +
        adjustAmount.hashCode;

  factory ResolvePaymentDto.fromJson(Map<String, dynamic> json) => _$ResolvePaymentDtoFromJson(json);
