...
class InviteByPhoneDto {
  ...
  InviteByPhoneDto({required this.phone, required this.role});
  ...
  bool operator ==(Object other) =>
      ...
      other is InviteByPhoneDto && other.phone == phone && other.role == role;

  @override
  int get hashCode => phone.hashCode + role.hashCode;

  factory InviteByPhoneDto.fromJson(Map<String, dynamic> json) =>
      _$InviteByPhoneDtoFromJson(json);
