...
class SetActiveRoleDto {
  ...
  final SetActiveRoleDtoRoleEnum role;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is SetActiveRoleDto &&
      other.role == role;
  ...
  factory SetActiveRoleDto.fromJson(Map<String, dynamic> json) => _$SetActiveRoleDtoFromJson(json);
